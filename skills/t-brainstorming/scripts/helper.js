(function() {
  ...
  function connect() {
    ...
    ws.onopen = () => {
      ...
      eventQueue = [];
      // Any reconnect may have missed a screen-added broadcast while offline.
      // Reload through the keyed bootstrap when possible so both the screen and
      // cookie are refreshed before the visible URL returns to bare /.
